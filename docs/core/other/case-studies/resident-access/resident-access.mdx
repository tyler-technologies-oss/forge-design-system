...
[white omnibar](/core-patterns/branding/community#2-omnibar-styling), [landing page layouts](/components/landing-page-layout), and account linking processes are
