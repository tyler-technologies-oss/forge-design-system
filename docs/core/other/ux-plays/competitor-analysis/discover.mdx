...
- You may conduct additional Discover UX Plays, such as [Interviews](/plays/interview) and [Surveys](/plays/survey) to validate your hypotheses.
- You are defining the experience by building a [Journey map](/plays/journey-mapping/define).
- You are defining the experience by building an [Episode](/plays/episode-model).
