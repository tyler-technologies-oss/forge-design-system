...
- You are building a [Journey map](/core/other/ux-plays/journey-mapping/define).
- You are building an [Episode model](/core/other/ux-plays/episode-model).
...
7. Analyze your findings. We recommend [Affinity mapping](/core/other/ux-plays/affinity-mapping) for qualitative data and Survey Monkey's report tool for quantitative data.
