...
- You are building a [Journey map](/plays/journey-mapping/define).
- You are building an [Episode model](/plays/episode-model).
...
7. Analyze your findings. We recommend [Affinity mapping](/plays/affinity-mapping) for qualitative data and Survey Monkey's report tool for quantitative data.
