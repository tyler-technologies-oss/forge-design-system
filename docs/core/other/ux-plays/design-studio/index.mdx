...
- You will assess the new experience by conducting a [heuristics evaluation](/core/other/ux-plays/heuristic-evaluation) or [usability test](/core/other/ux-plays/usability-test) with target users using your prototype.

---

## What you need

- Your defined [Episode](/core/other/ux-plays/episode-model): a persona, an outcome that persona is trying to accomplish, and a scenario.
