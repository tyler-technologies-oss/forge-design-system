...
- You have completed discover-stage UX Plays, such as [Interviews](/plays/interview), [Site visits](/plays/site-visit), and [Surveys](/plays/survey).
- You have identified your findings from the discover plays using[ Affinity mapping](/plays/affinity-mapping).
