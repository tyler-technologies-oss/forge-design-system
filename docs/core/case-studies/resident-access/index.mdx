...
Utility Access, Energov CSS, and Web Recording to create a robust platform of applications to meet citizen needs. 
...
team optimized the [omnibar](/components/omnibar#responsive), [tables](/components/table#responsive), [steppers](/components/stepper), and [tabs](/components/tabs/#responsive)
...
promote learnability throughout the apps. Since the apps integrate closely with other citizen apps, patterns and components such as a
[white omnibar](/core-patterns/branding/citizen#2-omnibar-styling), [landing page layouts](/components/landing-page-layout), and account linking processes are
shared among all of Tyler's citizen apps. 
...
that optimize for efficiency and integrate well with the broader citizen app ecosystem. 
...
- [tables](/components/table#responsive)
- [landing page layout](/components/landing-page-layout)
- [advanced search](/patterns/search-filter#1-initiate-search)
- [tabs](/components/tabs/#responsive)
