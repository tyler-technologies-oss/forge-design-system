...
The application uses a table with column filtering and customizable columns to allow users to view and interact with thousands of assets. The [table](/components/table)
...
The team was designing for a desktop or multi monitor experience, based on user feedback around common setups. The team opted for a [mini nav](/components/drawer#mini)
...
Assets have the potential for deep and complex hierarchies of data. Eric simplified a complex hierarchy using a combination of [tab](/components/tabs), anchored
...
- [table](/components/table-data/table) with filters, multi select, customizable columns
- [drawer](/components/navigation/drawer)
- [tab](/components/page/tabs)
- [scaffold](/components/layout/scaffold)
...
- <a href="https://xd.adobe.com/view/5264db89-29ca-4234-aad1-3f06a43f319b-0737/?fullscreen" target="_blank" rel="noopener noreferrer">Prototupe (Adobe XD)</a>
