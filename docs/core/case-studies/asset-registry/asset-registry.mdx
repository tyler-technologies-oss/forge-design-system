...
The application uses a table with column filtering and customizable columns to allow users to view and interact with thousands of assets. The [table](/components/table-data/table)
...
- [table](/components/table-data/table-data/table) with filters, multi select, customizable columns
