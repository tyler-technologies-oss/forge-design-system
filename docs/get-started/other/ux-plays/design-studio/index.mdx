...
- You have completed Define stage UX Plays, such as creating your [Episode](/get-started/other/ux-plays/episode-model).
...
- You will assess the new experience by conducting a [heuristics evaluation](/get-started/other/ux-plays/heuristic-evaluation) or [usability test](/get-started/other/ux-plays/usability-test) with target users using your prototype.

---

## What you need

- Your defined [Episode](/get-started/other/ux-plays/episode-model): a persona, an outcome that persona is trying to accomplish, and a scenario.
