...
- You may conduct additional Discover UX Plays, such as [Interviews](/get-started/other/ux-plays/interview/discover) and [Surveys](/get-started/other/ux-plays/survey/discover) to validate your hypotheses.
- You are defining the experience by building a [Journey map](/get-started/other/ux-plays/journey-mapping/define).
- You are defining the experience by building an [Episode](/get-started/other/ux-plays/episode-model).
