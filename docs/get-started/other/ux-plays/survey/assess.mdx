...
- You may conduct a [Design studio](/core/other/ux-plays/design-studio) to generate and align on your design.
...
8. Analyze your findings. We recommend [Affinity mapping](/core/other/ux-plays/affinity-mapping).
