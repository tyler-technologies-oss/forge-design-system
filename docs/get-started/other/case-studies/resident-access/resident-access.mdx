...
team optimized the [omnibar](/components/omnibar#responsive), [tables](/components/table/table#responsive), [steppers](/components/stepper), and [tabs](/components/navigation/tabs/#responsive)
...
[white omnibar](/get-started/branding-community#2-omnibar-styling), [landing page layouts](/components/landing-page-layout), and account linking processes are
