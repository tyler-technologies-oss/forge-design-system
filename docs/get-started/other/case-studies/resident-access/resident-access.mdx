...
team optimized the [omnibar](/components/omni/omnibar#responsive), [tables](/components/table/table#responsive), [steppers](/components/steppers/stepper), and [tabs](/components/navigation/tabs/#responsive)
...
[white omnibar](/get-started/branding-community#2-omnibar-styling), [landing page layouts](/components/layouts/landing-page-layout), and account linking processes are
shared among all of Tyler's community apps. 

Using [steppers](/components/steppers/stepper) to simplify complex flows such as applying for a business license, the team chunked information into mamageable steps and
...
- [tables](/components/table/table#responsive)
- [landing page layout](/components/layouts/landing-page-layout)
