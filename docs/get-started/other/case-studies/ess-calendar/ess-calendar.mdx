...
with Forge [typography](/styles/typography) and [colors](/styles/color). The team customized the calendar header with a
[toolbar](/components/page/toolbar/) and Forge header. 
...
- [filter sidesheet](/components/page/filter-sidesheet)
...
- [responsive design](/patterns/other/adaptive-design/#2-desktops--monitors)
- [external libraries](/assets/external-libraries)
