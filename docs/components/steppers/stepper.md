---
description: Steppers display progress through a sequence by breaking it up into multiple logical and numbered steps. 
keywords: ['wizard', 'progress', 'process', 'dialog', 'previous', 'next', 'steps']
---
...
![Example of a complex stepper.](/img/components/stepper/complex-stepper.png)
...
![Image of stepper parts.](/img/components/stepper/stepper-parts.png)
...
![Progress shown through a standard tcw-stepper. Completed steps are indicated with a check..](/img/components/stepper/stepper-linear.png)
...
![Progress shown through a stepper where users can edit previous steps. Completed steps may be indicated with an edit icon.](/img/components/stepper/stepper-editable.png)

</ImageBlock>

<ImageBlock padded={false} caption="Indicate errored steps with an error state.">

![Indicate errored steps with an error state.](/img/components/stepper/stepper-error.png)
...
![Image of stepper steps with text placed below the steps.](/img/components/stepper/stepper-alt.png)
...
![Stepper content is displayed either in a single or double columns.](/img/components/stepper/stepper-content.png)
...
![By default, a stepper an X in the top right corner, as well as Next, Previous, and Cancel in its action footer.](/img/components/stepper/stepper-default.png)
...
![When users may save changes, the stepper includes an X in the top right corner, as well as actions for Next, Previous, and Save and quit in its action footer.](/img/components/stepper/stepper-save.png)
...
![Prompt users to save their changes when they exit the stepper.](/img/components/stepper/confirm.gif)
