---
description: Lists are a continuous vertical group of text or images that may contain primary and supplemental actions.
keywords: ['list', 'one-line', 'two-line', 'three-line', 'collection', 'dense']
---
...
![Image of a single line list spaced with white space.](/img/components/list/list-spacers.png)
...
![Image of a single line list spaced with white space.](/img/components/list/list-types.png)
