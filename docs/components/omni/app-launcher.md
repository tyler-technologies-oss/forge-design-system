...
keywords: ['core element', 'core', 'element', 'apps', 'navigation', 'omnibar', 'figma']
---
...
![Diagram of the app launcher](/img/components/app-launcher/app-launcher-documentation.png)
...
![Diagram of the app launcher](/img/components/app-launcher/app-launcher-survey-results.png)
