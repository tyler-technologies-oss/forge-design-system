...
![Image of the omnibar with labeled sections.](/img/components/omnibar/omni-parts-diagram.png)
...
The omnibar in backoffice apps features the Tyler Talking T's logo and the app name, in title case (“General Ledger,” not “General ledger”). Branding guidance for public facing apps is pending.

<ImageBlock max-width="450px">

![Image of an omnibar with with a logo and title.](/img/components/omnibar/omni-branding-logo.png)
...
![Image of three actions within the omnibar.](/img/components/omnibar/omni-action-items.png)

</ImageBlock>

<ImageBlock caption="Additional action items may be placed in an overflow menu.">

![Image of actions in an overflow menu within the omnibar.](/img/components/omnibar/omni-action-items-overflow.png)
...
![Image of the user profile card.](/img/components/omnibar/omni-user-info.png)
...
![Image of three actions within the omnibar.](/img/components/omnibar/omni-desktop-help.png)
...
App launcher is required for backoffice guidance. See our guidance on the [app launcher page](/core-components/app-launcher/guidance).
...
![Image of three actions within the omnibar.](/img/components/omnibar/omni-desktop-profile-card.png)
...
![Image of an omnibar with option to login.](/img/components/omnibar/desktop-unauthenticated.png)
...
![Image of an omnibar with tabs inside.](/img/components/omnibar/omni-tabs-variant.png)
...
![Diagram of omni on mobile.](/img/components/omnibar/mobile-omni-diagram.png)
...
![Default and extended omni.](/img/components/omnibar/omni-extended.png)
...
![Mobile omni on scroll.](/img/components/omnibar/omni-scroll.gif)
...
![Overflow menu.](/img/components/omnibar/omni-overflow.png)

</ImageBlock>

<ImageBlock maxWidth="350px" caption="Tapping an item in the overflow menu reveals its children.">

![Items are tapped to reveal their children.](/img/components/omnibar/omni-overflow.gif)

</ImageBlock>

> **Note:** If the internal navigation drawer is opened while the overflow dropdown is open, the navigation drawer displays on top, with a scrim behind. The overflow menu stays open unless a user navigates to a new page. 
...
![Tap the search icon to reveal search.](/img/components/omnibar/omni-mobile-search.gif)
...
- The [scaffold](/components/scaffold) for page layout
