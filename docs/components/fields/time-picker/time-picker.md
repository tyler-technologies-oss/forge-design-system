...
:::info
Refer to the [data formatting guidance](/ux-writing/data-formats/dates-and-times) if using a custom mask. Both 12-hour and 24-hour time systems are allowed.
:::
