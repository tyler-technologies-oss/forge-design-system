---
description: The expansion panel displays summary information and reveals additional details on tap or click.
keywords: ['expansion', 'toggle', 'accordion', 'panel']
---
...
Use a an expansion panel to display additional info in a [card](../../components/card).
