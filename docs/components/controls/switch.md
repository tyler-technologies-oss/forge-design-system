...
keywords: ['Toggle', 'settings', 'form', 'submit', 'selection', 'select', 'checkbox', 'radio-button']
---
...
![Image of a button toggle with the options "List view, map view."](/img/components/switch/switch-dont.png)
