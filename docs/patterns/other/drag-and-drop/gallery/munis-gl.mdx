---
description: Account structures allows users to create custom account structures using drag and drop. 
keywords: ['error', 'forms', 'data', 'save', 'cancel', 'submit', 'text field']
---
